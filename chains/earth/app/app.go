...
func New(
	...
	app.EarthKeeper = *earthmodulekeeper.NewKeeper(
		appCodec,
		keys[earthmoduletypes.StoreKey],
		keys[earthmoduletypes.MemStoreKey],
	)
	earthModule := earthmodule.NewAppModule(appCodec, app.EarthKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(earthmoduletypes.ModuleName)
